...
class ResNeXt(nn.Module):
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.layer1 = self._make_layer(block, 64, layers[0], cardinality=32)
        self.layer2 = self._make_layer(block, 128, layers[1], stride=2, cardinality=32)
        self.layer3 = self._make_layer(block, 256, layers[2], stride=2, cardinality=32)
        self.layer4 = self._make_layer(block, 512, layers[3], stride=2, cardinality=32)
...
def resnext(pretrained=False):
    model = ResNeXt(ResNeXtBlock, [3, 4, 6, 3])
    if pretrained:
